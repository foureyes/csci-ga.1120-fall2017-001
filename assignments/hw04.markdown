...
1. __Start off by downloading__ [listutils.py](hw04/listutils.py) by right-clicking and choosing `Save As`
...
1. __Download__ [syllabic_poetry.py](hw04/syllabic_poetry.py) by right-clicking and choosing `Save As`
...
1. __Download__ [mydate.py](hw04/mydate.py) and [birthday.py](hw04/birthday.py) by right-clicking and choosing `Save As`
...
1. __Download__ [birthday.py](hw04/birthday.py) if you haven't done so already
